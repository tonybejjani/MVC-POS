...
/** @format */ var _esArrayIncludesJs = require("core-js/modules/es.array.includes.js");
var _webImmediateJs = require("core-js/modules/web.immediate.js");
// Data
// Icons
var _trashPng = require("url:../img/icon/trash.png");
...
class App {
    ...
    /*****************************************************************/ /*****************************************************************/ /*                                                               */ /*                            VIEWS                              */ /*                                                               */ /*****************************************************************/ /*****************************************************************/ _generateItemOrderMarkup(itemData, special) {
      ...
      <div class="item-content__thumb ${special ? `special-content__thumb` : ``}">
        ...
        ${special === false ? `<div class="order--item__remove"> <img src="${0, _trashPngDefault.default}#trash"></div>` : ""}
        ...
        return `<div class="special-container" data-special-item-id="${specialItemId}">
              <div class="special-container--header">
               ...
               <div class="order--item__remove" data-special-item-id="${specialItemId}">
                <img src="${0, _trashPngDefault.default}#trash">
               </div>
               <div class="order--item__edit" data-special-item-id="${specialItemId}">
                <img src="${0, _editPngDefault.default}">
               </div>               
              </div>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6Mibo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/** @format */ class infoView {
...
class menuCatView {
    ...
    _generateMarkup() {
        ...
        for (const { id: categoryId , active  } of Object.values(this.#data.menuCategories)){
